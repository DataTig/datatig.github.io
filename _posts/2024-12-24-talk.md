...
Hopefully it's not our fault the event when had problems!
...
It has information about every data set and the different formats it's available in.
...
Data in a kinda open format for reuse - The data is just on files and there are many ways to process it.

Lots of tools for building nice static website with the data  - I just showed you a list of 361 of them.

People can contribute with an approvals process (PR) & diffs (and they already know how to use Git).
...
(but [this blog post explains](https://opendataservices.coop/blog/2022/04/13/why-do-open-organisational-identifiers-matter.html) if you are interested).
...
If you log in with GitHub you can fill out a form , and sometimes it will try to make the commits in a new branch in GitHub for you. This hopefully reduces the technical barrier to contributing a bit.
...
[We wrote this blog post that goes into that more](https://opendataservices.coop/blog/2020/05/07/community-data.html).
