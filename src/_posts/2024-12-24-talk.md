...
description: "James was meant to give a talk at a local Python event in September. Unfortunately at the last minute the sponsor, venue and event fell through. Instead of wasting the talk we'll post it here (as we were going to do afterwards anyway). "
published_at: "2024-12-24 12:00:00"
